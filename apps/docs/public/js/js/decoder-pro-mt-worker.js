var Module = (() => {
  ...
  return function (Module) {
    ...
    Module["locateFile"] = function (url) {
      if (
        url == "decoder-pro-mt-worker.wasm" &&
      ...
      if (
        url == "decoder-pro-mt-worker.worker.js" &&
    ...
    function _fd_fdstat_get(fd, pbuf) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(9, 1, fd, pbuf);
      try {
        var stream = SYSCALLS.getStreamFromFD(fd);
        var type = stream.tty
          ? 2
    ...
    var asmLibraryArg = {
      ...
      D: __emscripten_default_pthread_stack_size,
      E: __emscripten_notify_task_queue,
      J: __emscripten_set_offscreencanvas_size,
      m: __emval_call_void_method,
      i: __emval_decref,
      ...
      O: _emscripten_unwind_to_js_event_loop,
      L: _environ_get,
    ...
    var _ff_h264_cabac_tables = (Module["_ff_h264_cabac_tables"] = 111557);
