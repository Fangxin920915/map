 ...
 * 提供了基本的图层管理和要素缓存功能
 */
export abstract class ModelManagerAbstract implements IModelManagerImp {
  layerCollection: ModelLayerImp[];

  abstract featureCache: ModelCacheImp;
   ...
   */
  abstract getCollection(type: ModelType): any;
  ...
  //   return false;
  // }
  abstract addLayer(layerId: string, features: ModelFeatureCollection): boolean;
